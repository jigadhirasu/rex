...
// func SwitchALL[A any](opts ...applyOption) PipeLine[Iterable[A], A] {
// 	return func(iterable Iterable[Iterable[A]]) Reader[A] {
// 		return _concat(iterable)
// 	}
// }

// func Switch[A any](iterables ...Iterable[A]) Reader[A] {
// 	return _concat(From(iterables...))
// }

// func _switch[A any](iterables Iterable[Iterable[A]]) Reader[A] {
